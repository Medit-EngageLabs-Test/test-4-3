...
# entrano nel percorso critico né nel budget del run. È il GATE PRIMARIO
# per-feature: la CI server-side completa gira solo sulla PR di release
# (index/**→main), non sulle PR di feature (vedi docs/agents/workflow.md,
# "Gate CI").
#
